	...
	function submitForm() {
		...
		$form.submit(function (e) {
			...
			$.ajax({
				...
				error: function(err) {
					$('#inputName').addClass('error').after('<span class="error-msg">Erreur dans le formulaire ou côté serveur, désolé. Rechargez la page ou envoyez votre réponse par mail à guillaume.juline@gmail.com</span>');
				}
			});
			e.preventDefault();
		});
